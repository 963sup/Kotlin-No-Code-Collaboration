...
object SampleDataSeeder {
    ...
    suspend fun seedInitialDataIfEmpty(dao: GovernanceDao) {
        ...
        val repoKotlinCollab = Repository(
            id = "repo_kotlin_collab",
            name = "Kotlin-No-Code-Collaboration",
            displayName = "963sup / Kotlin-No-Code-Collaboration",
            ownerType = OwnerType.ORGANIZATION,
            ownerId = orgCloud.id,
            ownerDisplayName = "963sup",
            enterpriseId = enterprise.id,
            description = "Kotlin No-Code mobile collaboration framework and field operating loop.",
            category = "Mobile Engineering",
            requiredApproverCount = 1,
            requireReviewerPass = true,
            preventSelfApproval = false,
        )
        val repoPlatformCollab = Repository(
            id = "repo_platform_collab",
            name = "No-Code-Collaboration-Platform",
            displayName = "963sup / No-Code-Collaboration-Platform",
            ownerType = OwnerType.ORGANIZATION,
            ownerId = orgCloud.id,
            ownerDisplayName = "963sup",
            enterpriseId = enterprise.id,
            description = "Enterprise No-Code collaboration platform with governance and verification gates.",
            category = "Cloud Platform",
            requiredApproverCount = 2,
            requireReviewerPass = true,
            preventSelfApproval = true,
        )
        dao.insertRepositories(listOf(repoMfg, repoEquip, repoCust, repoMkt, repoTrain, repo1, repo2, repo3, repoKotlinCollab, repoPlatformCollab))
        ...
        val notifications = listOf(
            ...
            AppNotification(
                id = "notif_workflow_fail_1",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "GitHub Actions",
                actorAvatarColorHex = "#EA4335",
                category = NotificationCategory.GOVERNANCE_EVENT,
                priority = NotificationPriority.URGENT,
                status = NotificationStatus.UNREAD,
                title = "Android Verification workflow run failed for main branch",
                body = "The run for main has failed.",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
                orgName = orgCloud.name,
                repoId = repoKotlinCollab.id,
                repoName = "963sup / Kotlin-No-Code-Collaboration",
                createdAt = now - 32400000L, // 9h ago
            ),
            AppNotification(
                id = "notif_workflow_fail_2",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "GitHub Actions",
                actorAvatarColorHex = "#EA4335",
                ...
                repoId = repoKotlinCollab.id,
                repoName = "963sup / Kotlin-No-Code-Collaboration",
                createdAt = now - 36000000L, // 10h ago
            ),
            AppNotification(
                id = "notif_workflow_fail_3",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "GitHub Actions",
                actorAvatarColorHex = "#EA4335",
                ...
                repoId = repoKotlinCollab.id,
                repoName = "963sup / Kotlin-No-Code-Collaboration",
                createdAt = now - 86400000L, // 1d ago
            ),
            AppNotification(
                id = "notif_dep_bump_okhttp",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "dependabot[bot]",
                actorAvatarColorHex = "#0366D6",
                category = NotificationCategory.REVIEW_REQUEST,
                priority = NotificationPriority.HIGH,
                status = NotificationStatus.UNREAD,
                title = "build(deps): bump okhttp from 4.10.0 to 5.4.0",
                body = "Bumps okhttp from 4.10.0 to 5.4.0 in gradle configuration.",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
                orgName = orgCloud.name,
                repoId = repoKotlinCollab.id,
                repoName = "963sup / Kotlin-No-Code-Collaboration #28",
                createdAt = now - 172800000L, // 2d ago
            ),
            AppNotification(
                id = "notif_feat_mobile_collab",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "963sup",
                actorAvatarColorHex = "#8B5CF6",
                category = NotificationCategory.PUBLICATION,
                priority = NotificationPriority.NORMAL,
                status = NotificationStatus.READ,
                title = "feat: mobile collaboration v2 field operating loop",
                body = "/codex-clean-branches-final",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
            ...
            AppNotification(
                ...
                priority = NotificationPriority.NORMAL,
                status = NotificationStatus.READ,
                title = "feat: open exact collaboration targets from Inbox",
                body = "Merged #19 into main.",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
            ...
            AppNotification(
                ...
                priority = NotificationPriority.NORMAL,
                status = NotificationStatus.READ,
                title = "feat: 建立手機協作主導覽、WBS 與亮色基礎",
                body = "Merged #18 into main.",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
            ...
            AppNotification(
                ...
                priority = NotificationPriority.NORMAL,
                status = NotificationStatus.READ,
                title = "feat: 全域工作看板、巢狀任務與繁體中文 UI",
                body = "Merged #13 into main.",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
            ...
            AppNotification(
                id = "notif_platform_ai_coldstart",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "963sup",
                actorAvatarColorHex = "#8B5CF6",
                ...
                priority = NotificationPriority.HIGH,
                status = NotificationStatus.UNREAD,
                title = "chore: bound AI cold-start context",
                body = "[vc]: #y7Sm18FHsjlnYLXdYskJ0z1rR3IXE...",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
                orgName = orgCloud.name,
                repoId = repoPlatformCollab.id,
                repoName = "963sup / No-Code-Collaboration-Platform #26",
                createdAt = now - 604800000L, // 7d ago
            ),
            AppNotification(
                id = "notif_platform_sec_delete",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "963sup",
                actorAvatarColorHex = "#8B5CF6",
                ...
                priority = NotificationPriority.HIGH,
                status = NotificationStatus.UNREAD,
                title = "fix(security): fail closed on Resource hard deletion",
                body = "[vc]: #URM6E/msWTFuN0TWCLAaYo/bw...",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
                orgName = orgCloud.name,
                repoId = repoPlatformCollab.id,
                repoName = "963sup / No-Code-Collaboration-Platform #22",
                createdAt = now - 691200000L, // 8d ago
            ),
            AppNotification(
                id = "notif_platform_semantic_routing",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "963sup",
                actorAvatarColorHex = "#8B5CF6",
                ...
                priority = NotificationPriority.NORMAL,
                status = NotificationStatus.UNREAD,
                title = "feat: establish semantic Repository web routing",
                body = "Merged #21 into main.",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
                orgName = orgCloud.name,
                repoId = repoPlatformCollab.id,
                repoName = "963sup / No-Code-Collaboration-Platform #21",
                createdAt = now - 691200000L, // 8d ago
            ),
            AppNotification(
                id = "notif_platform_auth_verify",
                recipientUserId = "usr_sarah_chen",
                actorUserId = "usr_sarah_chen",
                actorDisplayName = "963sup",
                actorAvatarColorHex = "#8B5CF6",
                ...
                priority = NotificationPriority.HIGH,
                status = NotificationStatus.UNREAD,
                title = "fix(auth): restore the verification gate",
                body = "[vc]: #49zy/f44aopQJx5KTjtw/6BLBOoffs...",
                isActionable = true,
                actionType = "VIEW_REPO",
                enterpriseId = enterprise.id,
                orgId = orgCloud.id,
                orgName = orgCloud.name,
                repoId = repoPlatformCollab.id,
                repoName = "963sup / No-Code-Collaboration-Platform #18",
                createdAt = now - 691200000L, // 8d ago
            ),
            AppNotification(
